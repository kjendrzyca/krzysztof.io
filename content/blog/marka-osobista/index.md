...
published: true
description: 'Marka osobista nie jest dla mnie celem. Jest efektem dobrze zrobionej roboty, której nie chowam do szuflady.'
banner: './banner.jpg'
---

Kiedyś myślałem, że aby stać się bardziej rozpoznawalnym w swojej branży, trzeba mieć jakiś plan. Z czasem okazało się, że u mnie działało coś prostszego: robić rzeczy, które mają sens, i nie chować ich do szuflady:
...
- A gdy wrzucałem codziennie przez 316 dni commity na GitHuba, to firmy zaczęły pisać do mnie z ofertami pracy, mimo że wtedy nie prowadziłem nawet LinkedIna. Dzisiaj widzę, że to był publiczny dowód konsekwencji i kompetencji.
...
A prawda jest taka, że wszystko jest wynikiem **uczenia się, realizowania ciekawych projektów i publicznego dzielenia się swoimi doświadczeniami**.
...
Po latach obserwacji nabrałem pewności, że najbardziej autentyczna marka osobista nie jest celem samym w sobie. Jest skutkiem ubocznym dobrej roboty, którą inni mogą zobaczyć. Jeśli musimy ludzi przekonywać, że robimy coś wartościowego, to nigdy nie mamy pewności, czy rzeczywiście nas cenią, czy np. tylko odwzajemniają przysługę lub [po prostu nas lubią i nie chcą zranić](https://www.momtestbook.com/).
...
Bardzo nie chciałbym trafić do miejsca, w którym deklaruję, że buduję markę osobistą poprzez pomaganie innym, ale tak naprawdę coraz częściej przepuszczam wszystko przez filtr: *czy to pomoże mojej marce osobistej*? Nie chodzi mi nawet o złe intencje. Bardziej o to, że taki tryb potrafi niepostrzeżenie przejąć stery.

W praktyce łatwo wtedy dojść do serii "pomocnych" postów, które są głównie wstępem do kolejnego newslettera, e-booka za maila albo kursu, a konkretu dla odbiorcy jest mniej, niż sugeruje obietnica.
...
Nie jest dla mnie celem. Jest efektem dobrze wykonanej roboty, której nie chowam do szuflady.
