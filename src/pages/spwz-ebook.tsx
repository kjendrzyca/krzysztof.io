...
const SPWZEbookPage = () => {
  const redirectToEbook = () => {
    window.location.href =
      'https://kjendrzyca.notion.site/Zacznij-dowozi-zadania-w-czasie-kr-tszym-o-po-ow-8073e7f6a8b44bcf8168ea178fed5901'
  }
  ...
  return (
    <Layout isLandingPage>
      ...
      >
        Sprawdzony w praktyce proces <strong>planowania i realizacji</strong> zadań dla programistów
        w <strong>7 krokach</strong>.
      </h2>
      ...
      <CenteredH2>Problem, z którym walczyłem miesiącami</CenteredH2>
...
Najgorsze było to poczucie, że kolejne zadanie może się skończyć podobnie. Nie miałem kontroli nad tym, co robię i czy w ogóle idę w dobrym kierunku.`}
      ...
      <CenteredH2>Co się zmieniło?</CenteredH2>
...
`}
      ...
      <CenteredH2>Co mi to dało w praktyce</CenteredH2>
...
`}
      ...
      <CenteredH2>Jak wygląda ten proces w praktyce</CenteredH2>
...
type PobieramButtonProps = {
  redirectToEbook: () => void
}

const PobieramButton = ({ redirectToEbook }: PobieramButtonProps) => (
  <button
    type="button"
...
const CenteredH2 = forwardRef<HTMLHeadingElement, CenteredH2Props>(({ children }, ref) => {
  return (
    <h2
      style={{
        textAlign: 'center',
