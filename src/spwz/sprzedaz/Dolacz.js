...
export const Dolacz = forwardRef((_, ref) => {
  return (
    <div ref={ref}>
      <CenteredH2>
        Dołącz teraz za <span style={{color: 'var(--color-success)', fontWeight: 'bold'}}>640 zł</span>
      </CenteredH2>
...
👉 **Program w tej cenie dostępny jest tylko przez kilka dni**. Potem zamykam sprzedaż, zajmuję się obsługą i ruszamy z pracą.`}
      ...
      <CenteredH2>
        <span style={{borderBottom: '2px dashed var(--color-primary)', lineHeight: '2.5rem',}}>Koniec sprzedaży: wtorek, 8 października 2024 o 20:00</span>
      </CenteredH2>
